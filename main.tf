...
module "eks_blueprints_addons" {
  ...
  external_dns_route53_zone_arns        = ["arn:aws:route53:::hostedzone/${local.hostedzone_id}"]
  enable_cert_manager                   = true
  cert_manager_route53_hosted_zone_arns = ["arn:aws:route53:::hostedzone/${local.hostedzone_id}"]
